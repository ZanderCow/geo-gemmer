...
with pool.connection() as conn:
        with conn.cursor(row_factory=dict_row) as cursor:
            cursor.execute('''
            DROP TABLE hidden_gem CASCADE;
            DROP TABLE review CASCADE;
            DROP TABLE image_group CASCADE;
            DROP TABLE accessibility CASCADE;
            DROP TABLE geo_user CASCADE;
            DROP TABLE geo_user_bio CASCADE;
            DROP TABLE gems_visited CASCADE;
            DROP TABLE gems_pinned CASCADE;
...
with pool.connection() as conn:
        with conn.cursor(row_factory=dict_row) as cursor:
            ...
            ''')
print("Created table hidden_gem")