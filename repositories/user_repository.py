...
def get_password(username):
    """
    gets the hased user password from the database given their username

    Args:
        username (str): The username of the user.
        entered_hashed_password (str): The entered hashed password thats hashed in the backend
    ...
    with pool.connection() as conn:
        with conn.cursor(row_factory=dict_row) as cursor:
            ...
            result = cursor.fetchone()  # Use the correct cursor variable
            return result
